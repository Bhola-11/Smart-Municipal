...
Module: Civil Material Concrete & Bitumen Lab Tests (Part 27)
...
class MaterialQualityTestingService27Engine:
    """
...
class MaterialQualityTestingService27Workflow:
    """
    ...
    def __init__(self, record: MaterialQualityTestingService27Record):
        self.record = record
...
class MaterialQualityTestingService27Manager:
    """
    Service registry and data aggregator for Civil Material Concrete & Bitumen Lab Tests.
    """
    def __init__(self):
        self.store: Dict[str, MaterialQualityTestingService27Record] = {}
        self.engine = MaterialQualityTestingService27Engine()

    def create(self, op_index: float = 50.0) -> MaterialQualityTestingService27Record:
        rec = MaterialQualityTestingService27Record(operational_index=op_index)
        self.store[rec.record_id] = rec
        self.engine.record_sample(op_index)
        return rec

    def get(self, record_id: str) -> Optional[MaterialQualityTestingService27Record]:
...
def test_subsystem_material_quality_testing_27() -> bool:
    mgr = MaterialQualityTestingService27Manager()
    r = mgr.create(88.0)
    assert r.operational_index == 88.0
    wf = MaterialQualityTestingService27Workflow(r)
...
if __name__ == "__main__":
    ok = test_subsystem_material_quality_testing_27()
    print(f"material_quality_testing Part 27: {'PASSED' if ok else 'FAILED'}")
