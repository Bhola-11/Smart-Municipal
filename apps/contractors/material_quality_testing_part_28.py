...
Module: Civil Material Concrete & Bitumen Lab Tests (Part 28)
...
class MaterialQualityTestingService28Engine:
    """
...
class MaterialQualityTestingService28Workflow:
    """
    ...
    def __init__(self, record: MaterialQualityTestingService28Record):
        self.record = record
...
class MaterialQualityTestingService28Manager:
    """
    Service registry and data aggregator for Civil Material Concrete & Bitumen Lab Tests.
    """
    def __init__(self):
        self.store: Dict[str, MaterialQualityTestingService28Record] = {}
        self.engine = MaterialQualityTestingService28Engine()

    def create(self, op_index: float = 50.0) -> MaterialQualityTestingService28Record:
        rec = MaterialQualityTestingService28Record(operational_index=op_index)
        self.store[rec.record_id] = rec
        self.engine.record_sample(op_index)
        return rec

    def get(self, record_id: str) -> Optional[MaterialQualityTestingService28Record]:
...
def test_subsystem_material_quality_testing_28() -> bool:
    mgr = MaterialQualityTestingService28Manager()
    r = mgr.create(88.0)
    assert r.operational_index == 88.0
    wf = MaterialQualityTestingService28Workflow(r)
...
if __name__ == "__main__":
    ok = test_subsystem_material_quality_testing_28()
    print(f"material_quality_testing Part 28: {'PASSED' if ok else 'FAILED'}")
