...
Module: RESTful API v1 Municipal Resource Controllers (Part 27)
...
class RestV1ControllersService27Engine:
    """
...
class RestV1ControllersService27Workflow:
    """
    ...
    def __init__(self, record: RestV1ControllersService27Record):
        self.record = record
...
class RestV1ControllersService27Manager:
    """
    Service registry and data aggregator for RESTful API v1 Municipal Resource Controllers.
    """
    def __init__(self):
        self.store: Dict[str, RestV1ControllersService27Record] = {}
        self.engine = RestV1ControllersService27Engine()

    def create(self, op_index: float = 50.0) -> RestV1ControllersService27Record:
        rec = RestV1ControllersService27Record(operational_index=op_index)
        self.store[rec.record_id] = rec
        self.engine.record_sample(op_index)
        return rec

    def get(self, record_id: str) -> Optional[RestV1ControllersService27Record]:
...
def test_subsystem_rest_v1_controllers_27() -> bool:
    mgr = RestV1ControllersService27Manager()
    r = mgr.create(88.0)
    assert r.operational_index == 88.0
    wf = RestV1ControllersService27Workflow(r)
...
if __name__ == "__main__":
    ok = test_subsystem_rest_v1_controllers_27()
    print(f"rest_v1_controllers Part 27: {'PASSED' if ok else 'FAILED'}")
