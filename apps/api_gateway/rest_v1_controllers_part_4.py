...
Module: RESTful API v1 Municipal Resource Controllers (Part 4)
...
class RestV1ControllersService4Engine:
    """
...
class RestV1ControllersService4Workflow:
    """
    ...
    def __init__(self, record: RestV1ControllersService4Record):
        self.record = record
...
class RestV1ControllersService4Manager:
    """
    Service registry and data aggregator for RESTful API v1 Municipal Resource Controllers.
    """
    def __init__(self):
        self.store: Dict[str, RestV1ControllersService4Record] = {}
        self.engine = RestV1ControllersService4Engine()

    def create(self, op_index: float = 50.0) -> RestV1ControllersService4Record:
        rec = RestV1ControllersService4Record(operational_index=op_index)
        self.store[rec.record_id] = rec
        self.engine.record_sample(op_index)
        return rec

    def get(self, record_id: str) -> Optional[RestV1ControllersService4Record]:
...
def test_subsystem_rest_v1_controllers_4() -> bool:
    mgr = RestV1ControllersService4Manager()
    r = mgr.create(88.0)
    assert r.operational_index == 88.0
    wf = RestV1ControllersService4Workflow(r)
...
if __name__ == "__main__":
    ok = test_subsystem_rest_v1_controllers_4()
    print(f"rest_v1_controllers Part 4: {'PASSED' if ok else 'FAILED'}")
