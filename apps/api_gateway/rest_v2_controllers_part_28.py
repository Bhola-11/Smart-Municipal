...
Module: RESTful API v2 Hypermedia Hateoas Controllers (Part 28)
...
class RestV2ControllersService28Engine:
    """
...
class RestV2ControllersService28Workflow:
    """
    ...
    def __init__(self, record: RestV2ControllersService28Record):
        self.record = record
...
class RestV2ControllersService28Manager:
    """
    Service registry and data aggregator for RESTful API v2 Hypermedia Hateoas Controllers.
    """
    def __init__(self):
        self.store: Dict[str, RestV2ControllersService28Record] = {}
        self.engine = RestV2ControllersService28Engine()

    def create(self, op_index: float = 50.0) -> RestV2ControllersService28Record:
        rec = RestV2ControllersService28Record(operational_index=op_index)
        self.store[rec.record_id] = rec
        self.engine.record_sample(op_index)
        return rec

    def get(self, record_id: str) -> Optional[RestV2ControllersService28Record]:
...
def test_subsystem_rest_v2_controllers_28() -> bool:
    mgr = RestV2ControllersService28Manager()
    r = mgr.create(88.0)
    assert r.operational_index == 88.0
    wf = RestV2ControllersService28Workflow(r)
...
if __name__ == "__main__":
    ok = test_subsystem_rest_v2_controllers_28()
    print(f"rest_v2_controllers Part 28: {'PASSED' if ok else 'FAILED'}")
