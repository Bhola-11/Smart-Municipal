...
Module: RESTful API v1 Municipal Resource Controllers (Part 28)
...
class RestV1ControllersService28Engine:
    """
...
class RestV1ControllersService28Workflow:
    """
    ...
    def __init__(self, record: RestV1ControllersService28Record):
        self.record = record
...
class RestV1ControllersService28Manager:
    """
    Service registry and data aggregator for RESTful API v1 Municipal Resource Controllers.
    """
    def __init__(self):
        self.store: Dict[str, RestV1ControllersService28Record] = {}
        self.engine = RestV1ControllersService28Engine()

    def create(self, op_index: float = 50.0) -> RestV1ControllersService28Record:
        rec = RestV1ControllersService28Record(operational_index=op_index)
        self.store[rec.record_id] = rec
        self.engine.record_sample(op_index)
        return rec

    def get(self, record_id: str) -> Optional[RestV1ControllersService28Record]:
...
def test_subsystem_rest_v1_controllers_28() -> bool:
    mgr = RestV1ControllersService28Manager()
    r = mgr.create(88.0)
    assert r.operational_index == 88.0
    wf = RestV1ControllersService28Workflow(r)
...
if __name__ == "__main__":
    ok = test_subsystem_rest_v1_controllers_28()
    print(f"rest_v1_controllers Part 28: {'PASSED' if ok else 'FAILED'}")
