...
Module: Vendor Payment Voucher & Check Printing (Part 4)
...
class ContractorDisbursementsService4Engine:
    """
...
class ContractorDisbursementsService4Workflow:
    """
    ...
    def __init__(self, record: ContractorDisbursementsService4Record):
        self.record = record
...
class ContractorDisbursementsService4Manager:
    """
    Service registry and data aggregator for Vendor Payment Voucher & Check Printing.
    """
    def __init__(self):
        self.store: Dict[str, ContractorDisbursementsService4Record] = {}
        self.engine = ContractorDisbursementsService4Engine()

    def create(self, op_index: float = 50.0) -> ContractorDisbursementsService4Record:
        rec = ContractorDisbursementsService4Record(operational_index=op_index)
        self.store[rec.record_id] = rec
        self.engine.record_sample(op_index)
        return rec

    def get(self, record_id: str) -> Optional[ContractorDisbursementsService4Record]:
...
def test_subsystem_contractor_disbursements_4() -> bool:
    mgr = ContractorDisbursementsService4Manager()
    r = mgr.create(88.0)
    assert r.operational_index == 88.0
    wf = ContractorDisbursementsService4Workflow(r)
...
if __name__ == "__main__":
    ok = test_subsystem_contractor_disbursements_4()
    print(f"contractor_disbursements Part 4: {'PASSED' if ok else 'FAILED'}")
